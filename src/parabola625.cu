...
__device__ double d_M_CrCr(double XCR, double XNB)
{
	...
	M_CrCr_result = 1.8295676400933012e-26*pow(XCR, 2)*exp(-8.5221193705645018*XCR*(-XCR - XNB + 1) + 4.0036674816806448*XCR - 0.81532998999390471*XNB) + 1.7235555733323438e-25*pow(XCR, 2)*exp(-1.8707061811433989*XNB) + 3.5027570743586953e-26*(1 - XCR)*(1 - XCR)*exp(-7.1543718172640256*XCR*(-XCR - XNB + 1) + 3.3541967644499233*XCR);
...
__device__ double d_M_NbNb(double XCR, double XNB)
{
	...
	M_NbNb_result = 3.5027570743586953e-26*pow(XNB, 2)*exp(-7.1543718172640256*XCR*(-XCR - XNB + 1) + 3.3541967644499233*XCR) + 1.8295676400933012e-26*pow(XNB, 2)*exp(-8.5221193705645018*XCR*(-XCR - XNB + 1) + 4.0036674816806448*XCR - 0.81532998999390471*XNB) + 1.7235555733323438e-25*(1 - XNB)*(1 - XNB)*exp(-1.8707061811433989*XNB);
