...
__device__ double d_L0_Cr(double XCR, double XNB)
{
...
__device__ double d_L0_Nb(double XCR, double XNB)
{
...
__device__ double d_L0_Ni(double XCR, double XNB)
{
	                                                                                                                                        ...
	                                                                                                                                        : (
	                                                                                                                                                ...
	                                                                                                                                                : (
	                                                                                                                                                        ...
	                                                                                                                                                        : (
	                                                                                                                                                                ...
	                                                                                                                                                                : (
	                                                                                                                                                                        1.0
	                                                                                                                                                                )) + 1, 2) - 2111099999.9999998*(XCR + XNB - 1)*(XCR + XNB - 1) + 950472067.50000012*((XCR + XNB - 1 < -1.0e-13) ? (
	                                                                                                                                                                        -1/(XCR + XNB - 1)
	                                                                                                                                                                        )
	                                                                                                                                                                        : (
	                                                                                                                                                                                0
	                                                                                                                                                                        ...
	                                                                                                                                                                        : (
	                                                                                                                                                                                ...
	                                                                                                                                                                                : (
	                                                                                                                                                                                        ...
	                                                                                                                                                                                        : (
	                                                                                                                                                                                                ...
	                                                                                                                                                                                                (3605*XCR - 633)*(3605*XCR - 633)*(3127984108.0821762 + 2.3268190314398873e+27/pow((3605*XCR*(-XCR - XNB + 1) + 1742*XCR + 633*XNB - 633)*((3605*XCR*(XCR + XNB - 1) - 1742*XCR - 633*XNB + 633 <= 0) ? (
	                                                                                                                                                                                                        -0.33333333333333298
	                                                                                                                                                                                                        )
	                                                                                                                                                                                                        : (
	                                                                                                                                                                                                                1.0
	                                                                                                                                                                                        ...
	                                                                                                                                                                                        : (
	                                                                                                                                                                                                (3605*XCR - 633)*(3605*XCR - 633)*pow((3605*XCR*(-XCR - XNB + 1) + 1742*XCR + 633*XNB - 633)*((3605*XCR*(XCR + XNB - 1) - 1742*XCR - 633*XNB + 633 <= 0) ? (
	                                                                                                                                                                                                        -0.33333333333333298
	                                                                                                                                                                                                        )
	                                                                                                                                                                                                        : (
	                                                                                                                                                                                                                1.0
...
__device__ double d_D_NbCr(double XCR, double XNB)
{
	...
	D_NbCr_result = 1.0000000000000001e-5*(3.5027570743586952e-21*XCR*pow(XNB, 2)*exp(-7.1543718172640256*XCR*(-XCR - XNB + 1) + 3.3541967644499233*XCR) + 1.8295676400933012e-21*pow(XNB, 2)*(-XCR - XNB + 1)*exp(-8.5221193705645018*XCR*(-XCR - XNB + 1) + 4.0036674816806448*XCR - 442.62877981749585*XNB*(-XCR - XNB + 1) - 0.82164267100913768*XNB) + 1.4170990277916469e-20*XNB*(1 - XNB)*(1 - XNB)*exp(-34.982563536715503*XNB*(-XCR - XNB + 1) + 14.437947842988088*XNB))*(2111099999.9999998*pow(XCR, 2) + 4222199999.9999995*XCR*XNB - 22796300390.899994*XCR + 2111099999.9999998*pow(XNB, 2) - 44791752420.699997*XNB + 950472067.50000012*(1.9099999999999999*XCR - 0.52000000000000002)*((1.9099999999999999*XCR*(XCR + XNB - 1) - 2.98*XCR - 0.52000000000000002*XNB + 0.52000000000000002 <= 0) ? (
	                    -0.33333333333333298
	                )
	                : (
	                    1.0
...
__device__ double d_D_NbNb(double XCR, double XNB)
{
	...
	D_NbNb_result = 1.0000000000000001e-5*(3.5027570743586952e-21*XCR*pow(XNB, 2)*exp(-7.1543718172640256*XCR*(-XCR - XNB + 1) + 3.3541967644499233*XCR) + 1.8295676400933012e-21*pow(XNB, 2)*(-XCR - XNB + 1)*exp(-8.5221193705645018*XCR*(-XCR - XNB + 1) + 4.0036674816806448*XCR - 442.62877981749585*XNB*(-XCR - XNB + 1) - 0.82164267100913768*XNB) + 1.4170990277916469e-20*XNB*(1 - XNB)*(1 - XNB)*exp(-34.982563536715503*XNB*(-XCR - XNB + 1) + 14.437947842988088*XNB))*(4222199999.9999995*pow(XCR, 2) + 4222199999.9999995*XCR*XNB - 4222199999.9999995*XCR*(XCR + XNB - 1) - 44791752420.699997*XCR - 83684217653.399994*XNB - 3467417149.4467502*pow(XCR - 0.27225130890052357, 2)*((1.9099999999999999*XCR*(XCR + XNB - 1) - 2.98*XCR - 0.52000000000000002*XNB + 0.52000000000000002 <= 0) ? (
	                    0.11111111111111088
	                )
	                : (
	                    1.0
