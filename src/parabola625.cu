...
__device__ double d_s_delta() {
   ...
   s_delta_result = 0.12745000000000001;
...
__device__ double d_s_laves() {
   ...
   s_laves_result = 0.16875000000000001;
...
__device__ double d_g_del(double XCR, double XNB) {
   ...
   double g_del_result;
   g_del_result = 19076223392.853703*(XCR - 0.0258)*(XCR - 0.0258) + (16983307497.06665*XCR - 438169333.42431957)*(XNB - 0.24399999999999999) + 85911591727.909775*pow(XNB - 0.24399999999999999, 2);
   return g_del_result;
...
__device__ double d_g_lav(double XCR, double XNB) {
   ...
   double g_lav_result;
   g_lav_result = 8880622842.3634224*(XCR - 0.375)*(XCR - 0.375) + (23980778596.615067*XCR - 8992791973.7306499)*(XNB - 0.25900000000000001) + 97731010299.215485*pow(XNB - 0.25900000000000001, 2);
   return g_lav_result;
