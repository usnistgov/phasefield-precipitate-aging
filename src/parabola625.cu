...
__device__ double d_M_Nb(double XNB)
{
	...
	double M_Nb_result;
	M_Nb_result = 1.7235555733323437e-20*exp(-1.8707061811433989*XNB);
	return M_Nb_result;
...
__device__ double d_M_Ni(double XCR, double XNB)
{
	...
	double M_Ni_result;
	M_Ni_result = 1.8295676400933012e-21*exp(-8.5221193705645018*XCR*(-XCR - XNB + 1) + 4.0036674816806448*XCR - 0.81532998999390471*XNB);
	return M_Ni_result;
...
__device__ double d_M_CrCr(double XCR, double XNB)
{
	...
	M_CrCr_result = 1.7235555733323438e-25*XCR*XNB*exp(-1.8707061811433989*XNB) + 1.8295676400933012e-26*XCR*(-XCR - XNB + 1)*exp(-8.5221193705645018*XCR*(-XCR - XNB + 1) + 4.0036674816806448*XCR - 0.81532998999390471*XNB) + 3.5027570743586953e-26*(1 - XCR)*(1 - XCR)*exp(-7.1543718172640256*XCR*(-XCR - XNB + 1) + 3.3541967644499233*XCR);
...
__device__ double d_M_CrNb(double XCR, double XNB)
{
	...
	M_CrNb_result = -3.5027570743586953e-26*XCR*(1 - XCR)*exp(-7.1543718172640256*XCR*(-XCR - XNB + 1) + 3.3541967644499233*XCR) - 1.7235555733323438e-25*XCR*(1 - XNB)*exp(-1.8707061811433989*XNB) + 1.8295676400933012e-26*XCR*(-XCR - XNB + 1)*exp(-8.5221193705645018*XCR*(-XCR - XNB + 1) + 4.0036674816806448*XCR - 0.81532998999390471*XNB);
...
__device__ double d_M_NbCr(double XCR, double XNB)
{
	...
	M_NbCr_result = -3.5027570743586953e-26*XNB*(1 - XCR)*exp(-7.1543718172640256*XCR*(-XCR - XNB + 1) + 3.3541967644499233*XCR) - 1.7235555733323438e-25*XNB*(1 - XNB)*exp(-1.8707061811433989*XNB) - 1.8295676400933012e-26*XNB*(XCR + XNB)*exp(-8.5221193705645018*XCR*(-XCR - XNB + 1) + 4.0036674816806448*XCR - 0.81532998999390471*XNB);
...
__device__ double d_M_NbNb(double XCR, double XNB)
{
	...
	M_NbNb_result = 3.5027570743586953e-26*XCR*XNB*exp(-7.1543718172640256*XCR*(-XCR - XNB + 1) + 3.3541967644499233*XCR) + 1.8295676400933012e-26*XNB*(-XCR - XNB + 1)*exp(-8.5221193705645018*XCR*(-XCR - XNB + 1) + 4.0036674816806448*XCR - 0.81532998999390471*XNB) + 1.7235555733323438e-25*(1 - XNB)*(1 - XNB)*exp(-1.8707061811433989*XNB);
...
__device__ double d_D_CrCr(double XCR, double XNB)
{
	...
	D_CrCr_result = -XCR*(-XCR*(3.5027570743586953e-26*XCR*XNB*exp(-7.1543718172640256*XCR*(-XCR - XNB + 1) + 3.3541967644499233*XCR) - 1.7235555733323438e-25*XNB*(1 - XNB)*exp(-1.8707061811433989*XNB) - 1.8295676400933012e-26*XNB*(XCR + XNB)*exp(-8.5221193705645018*XCR*(-XCR - XNB + 1) + 4.0036674816806448*XCR - 0.81532998999390471*XNB)) - XCR*(3.5027570743586953e-26*XCR*(-XCR - XNB + 1)*exp(-7.1543718172640256*XCR*(-XCR - XNB + 1) + 3.3541967644499233*XCR) + 1.7235555733323438e-25*XNB*(-XCR - XNB + 1)*exp(-1.8707061811433989*XNB) + 1.8295676400933012e-26*(XCR + XNB)*(XCR + XNB)*exp(-8.5221193705645018*XCR*(-XCR - XNB + 1) + 4.0036674816806448*XCR - 0.81532998999390471*XNB)) + (1 - XCR)*(1.7235555733323438e-25*XCR*XNB*exp(-1.8707061811433989*XNB) - 3.5027570743586953e-26*XCR*(1 - XCR)*exp(-7.1543718172640256*XCR*(-XCR - XNB + 1) + 3.3541967644499233*XCR) - 1.8295676400933012e-26*XCR*(XCR + XNB)*exp(-8.5221193705645018*XCR*(-XCR - XNB + 1) + 4.0036674816806448*XCR - 0.81532998999390471*XNB))) - XCR*(-XCR*(3.5027570743586953e-26*XCR*XNB*exp(-7.1543718172640256*XCR*(-XCR - XNB + 1) + 3.3541967644499233*XCR) + 1.8295676400933012e-26*XNB*(-XCR - XNB + 1)*exp(-8.5221193705645018*XCR*(-XCR - XNB + 1) + 4.0036674816806448*XCR - 0.81532998999390471*XNB) + 1.7235555733323438e-25*(1 - XNB)*(1 - XNB)*exp(-1.8707061811433989*XNB)) - XCR*(3.5027570743586953e-26*XCR*(-XCR - XNB + 1)*exp(-7.1543718172640256*XCR*(-XCR - XNB + 1) + 3.3541967644499233*XCR) - 1.7235555733323438e-25*(1 - XNB)*(-XCR - XNB + 1)*exp(-1.8707061811433989*XNB) - 1.8295676400933012e-26*(XCR + XNB)*(-XCR - XNB + 1)*exp(-8.5221193705645018*XCR*(-XCR - XNB + 1) + 4.0036674816806448*XCR - 0.81532998999390471*XNB)) + (1 - XCR)*(-3.5027570743586953e-26*XCR*(1 - XCR)*exp(-7.1543718172640256*XCR*(-XCR - XNB + 1) + 3.3541967644499233*XCR) - 1.7235555733323438e-25*XCR*(1 - XNB)*exp(-1.8707061811433989*XNB) + 1.8295676400933012e-26*XCR*(-XCR - XNB + 1)*exp(-8.5221193705645018*XCR*(-XCR - XNB + 1) + 4.0036674816806448*XCR - 0.81532998999390471*XNB))) + (1 - XCR)*(-XCR*(-3.5027570743586953e-26*XNB*(1 - XCR)*exp(-7.1543718172640256*XCR*(-XCR - XNB + 1) + 3.3541967644499233*XCR) - 1.7235555733323438e-25*XNB*(1 - XNB)*exp(-1.8707061811433989*XNB) - 1.8295676400933012e-26*XNB*(XCR + XNB)*exp(-8.5221193705645018*XCR*(-XCR - XNB + 1) + 4.0036674816806448*XCR - 0.81532998999390471*XNB)) - XCR*(1.7235555733323438e-25*XNB*(-XCR - XNB + 1)*exp(-1.8707061811433989*XNB) - 3.5027570743586953e-26*(1 - XCR)*(-XCR - XNB + 1)*exp(-7.1543718172640256*XCR*(-XCR - XNB + 1) + 3.3541967644499233*XCR) - 1.8295676400933012e-26*(XCR + XNB)*(-XCR - XNB + 1)*exp(-8.5221193705645018*XCR*(-XCR - XNB + 1) + 4.0036674816806448*XCR - 0.81532998999390471*XNB)) + (1 - XCR)*(1.7235555733323438e-25*XCR*XNB*exp(-1.8707061811433989*XNB) + 1.8295676400933012e-26*XCR*(-XCR - XNB + 1)*exp(-8.5221193705645018*XCR*(-XCR - XNB + 1) + 4.0036674816806448*XCR - 0.81532998999390471*XNB) + 3.5027570743586953e-26*(1 - XCR)*(1 - XCR)*exp(-7.1543718172640256*XCR*(-XCR - XNB + 1) + 3.3541967644499233*XCR)));
...
__device__ double d_D_CrNb(double XCR, double XNB)
{
	...
	D_CrNb_result = -XNB*(-XCR*(3.5027570743586953e-26*XCR*XNB*exp(-7.1543718172640256*XCR*(-XCR - XNB + 1) + 3.3541967644499233*XCR) - 1.7235555733323438e-25*XNB*(1 - XNB)*exp(-1.8707061811433989*XNB) - 1.8295676400933012e-26*XNB*(XCR + XNB)*exp(-8.5221193705645018*XCR*(-XCR - XNB + 1) + 4.0036674816806448*XCR - 0.81532998999390471*XNB)) - XCR*(3.5027570743586953e-26*XCR*(-XCR - XNB + 1)*exp(-7.1543718172640256*XCR*(-XCR - XNB + 1) + 3.3541967644499233*XCR) + 1.7235555733323438e-25*XNB*(-XCR - XNB + 1)*exp(-1.8707061811433989*XNB) + 1.8295676400933012e-26*(XCR + XNB)*(XCR + XNB)*exp(-8.5221193705645018*XCR*(-XCR - XNB + 1) + 4.0036674816806448*XCR - 0.81532998999390471*XNB)) + (1 - XCR)*(1.7235555733323438e-25*XCR*XNB*exp(-1.8707061811433989*XNB) - 3.5027570743586953e-26*XCR*(1 - XCR)*exp(-7.1543718172640256*XCR*(-XCR - XNB + 1) + 3.3541967644499233*XCR) - 1.8295676400933012e-26*XCR*(XCR + XNB)*exp(-8.5221193705645018*XCR*(-XCR - XNB + 1) + 4.0036674816806448*XCR - 0.81532998999390471*XNB))) - XNB*(-XCR*(-3.5027570743586953e-26*XNB*(1 - XCR)*exp(-7.1543718172640256*XCR*(-XCR - XNB + 1) + 3.3541967644499233*XCR) - 1.7235555733323438e-25*XNB*(1 - XNB)*exp(-1.8707061811433989*XNB) - 1.8295676400933012e-26*XNB*(XCR + XNB)*exp(-8.5221193705645018*XCR*(-XCR - XNB + 1) + 4.0036674816806448*XCR - 0.81532998999390471*XNB)) - XCR*(1.7235555733323438e-25*XNB*(-XCR - XNB + 1)*exp(-1.8707061811433989*XNB) - 3.5027570743586953e-26*(1 - XCR)*(-XCR - XNB + 1)*exp(-7.1543718172640256*XCR*(-XCR - XNB + 1) + 3.3541967644499233*XCR) - 1.8295676400933012e-26*(XCR + XNB)*(-XCR - XNB + 1)*exp(-8.5221193705645018*XCR*(-XCR - XNB + 1) + 4.0036674816806448*XCR - 0.81532998999390471*XNB)) + (1 - XCR)*(1.7235555733323438e-25*XCR*XNB*exp(-1.8707061811433989*XNB) + 1.8295676400933012e-26*XCR*(-XCR - XNB + 1)*exp(-8.5221193705645018*XCR*(-XCR - XNB + 1) + 4.0036674816806448*XCR - 0.81532998999390471*XNB) + 3.5027570743586953e-26*(1 - XCR)*(1 - XCR)*exp(-7.1543718172640256*XCR*(-XCR - XNB + 1) + 3.3541967644499233*XCR))) + (1 - XNB)*(-XCR*(3.5027570743586953e-26*XCR*XNB*exp(-7.1543718172640256*XCR*(-XCR - XNB + 1) + 3.3541967644499233*XCR) + 1.8295676400933012e-26*XNB*(-XCR - XNB + 1)*exp(-8.5221193705645018*XCR*(-XCR - XNB + 1) + 4.0036674816806448*XCR - 0.81532998999390471*XNB) + 1.7235555733323438e-25*(1 - XNB)*(1 - XNB)*exp(-1.8707061811433989*XNB)) - XCR*(3.5027570743586953e-26*XCR*(-XCR - XNB + 1)*exp(-7.1543718172640256*XCR*(-XCR - XNB + 1) + 3.3541967644499233*XCR) - 1.7235555733323438e-25*(1 - XNB)*(-XCR - XNB + 1)*exp(-1.8707061811433989*XNB) - 1.8295676400933012e-26*(XCR + XNB)*(-XCR - XNB + 1)*exp(-8.5221193705645018*XCR*(-XCR - XNB + 1) + 4.0036674816806448*XCR - 0.81532998999390471*XNB)) + (1 - XCR)*(-3.5027570743586953e-26*XCR*(1 - XCR)*exp(-7.1543718172640256*XCR*(-XCR - XNB + 1) + 3.3541967644499233*XCR) - 1.7235555733323438e-25*XCR*(1 - XNB)*exp(-1.8707061811433989*XNB) + 1.8295676400933012e-26*XCR*(-XCR - XNB + 1)*exp(-8.5221193705645018*XCR*(-XCR - XNB + 1) + 4.0036674816806448*XCR - 0.81532998999390471*XNB)));
...
__device__ double d_D_NbCr(double XCR, double XNB)
{
	...
	D_NbCr_result = -XCR*(-XNB*(1.7235555733323438e-25*XCR*XNB*exp(-1.8707061811433989*XNB) - 3.5027570743586953e-26*XCR*(1 - XCR)*exp(-7.1543718172640256*XCR*(-XCR - XNB + 1) + 3.3541967644499233*XCR) - 1.8295676400933012e-26*XCR*(XCR + XNB)*exp(-8.5221193705645018*XCR*(-XCR - XNB + 1) + 4.0036674816806448*XCR - 0.81532998999390471*XNB)) - XNB*(3.5027570743586953e-26*XCR*(-XCR - XNB + 1)*exp(-7.1543718172640256*XCR*(-XCR - XNB + 1) + 3.3541967644499233*XCR) + 1.7235555733323438e-25*XNB*(-XCR - XNB + 1)*exp(-1.8707061811433989*XNB) + 1.8295676400933012e-26*(XCR + XNB)*(XCR + XNB)*exp(-8.5221193705645018*XCR*(-XCR - XNB + 1) + 4.0036674816806448*XCR - 0.81532998999390471*XNB)) + (1 - XNB)*(3.5027570743586953e-26*XCR*XNB*exp(-7.1543718172640256*XCR*(-XCR - XNB + 1) + 3.3541967644499233*XCR) - 1.7235555733323438e-25*XNB*(1 - XNB)*exp(-1.8707061811433989*XNB) - 1.8295676400933012e-26*XNB*(XCR + XNB)*exp(-8.5221193705645018*XCR*(-XCR - XNB + 1) + 4.0036674816806448*XCR - 0.81532998999390471*XNB))) - XCR*(-XNB*(-3.5027570743586953e-26*XCR*(1 - XCR)*exp(-7.1543718172640256*XCR*(-XCR - XNB + 1) + 3.3541967644499233*XCR) - 1.7235555733323438e-25*XCR*(1 - XNB)*exp(-1.8707061811433989*XNB) + 1.8295676400933012e-26*XCR*(-XCR - XNB + 1)*exp(-8.5221193705645018*XCR*(-XCR - XNB + 1) + 4.0036674816806448*XCR - 0.81532998999390471*XNB)) - XNB*(3.5027570743586953e-26*XCR*(-XCR - XNB + 1)*exp(-7.1543718172640256*XCR*(-XCR - XNB + 1) + 3.3541967644499233*XCR) - 1.7235555733323438e-25*(1 - XNB)*(-XCR - XNB + 1)*exp(-1.8707061811433989*XNB) - 1.8295676400933012e-26*(XCR + XNB)*(-XCR - XNB + 1)*exp(-8.5221193705645018*XCR*(-XCR - XNB + 1) + 4.0036674816806448*XCR - 0.81532998999390471*XNB)) + (1 - XNB)*(3.5027570743586953e-26*XCR*XNB*exp(-7.1543718172640256*XCR*(-XCR - XNB + 1) + 3.3541967644499233*XCR) + 1.8295676400933012e-26*XNB*(-XCR - XNB + 1)*exp(-8.5221193705645018*XCR*(-XCR - XNB + 1) + 4.0036674816806448*XCR - 0.81532998999390471*XNB) + 1.7235555733323438e-25*(1 - XNB)*(1 - XNB)*exp(-1.8707061811433989*XNB))) + (1 - XCR)*(-XNB*(1.7235555733323438e-25*XCR*XNB*exp(-1.8707061811433989*XNB) + 1.8295676400933012e-26*XCR*(-XCR - XNB + 1)*exp(-8.5221193705645018*XCR*(-XCR - XNB + 1) + 4.0036674816806448*XCR - 0.81532998999390471*XNB) + 3.5027570743586953e-26*(1 - XCR)*(1 - XCR)*exp(-7.1543718172640256*XCR*(-XCR - XNB + 1) + 3.3541967644499233*XCR)) - XNB*(1.7235555733323438e-25*XNB*(-XCR - XNB + 1)*exp(-1.8707061811433989*XNB) - 3.5027570743586953e-26*(1 - XCR)*(-XCR - XNB + 1)*exp(-7.1543718172640256*XCR*(-XCR - XNB + 1) + 3.3541967644499233*XCR) - 1.8295676400933012e-26*(XCR + XNB)*(-XCR - XNB + 1)*exp(-8.5221193705645018*XCR*(-XCR - XNB + 1) + 4.0036674816806448*XCR - 0.81532998999390471*XNB)) + (1 - XNB)*(-3.5027570743586953e-26*XNB*(1 - XCR)*exp(-7.1543718172640256*XCR*(-XCR - XNB + 1) + 3.3541967644499233*XCR) - 1.7235555733323438e-25*XNB*(1 - XNB)*exp(-1.8707061811433989*XNB) - 1.8295676400933012e-26*XNB*(XCR + XNB)*exp(-8.5221193705645018*XCR*(-XCR - XNB + 1) + 4.0036674816806448*XCR - 0.81532998999390471*XNB)));
...
__device__ double d_D_NbNb(double XCR, double XNB)
{
	...
	D_NbNb_result = -XNB*(-XNB*(1.7235555733323438e-25*XCR*XNB*exp(-1.8707061811433989*XNB) - 3.5027570743586953e-26*XCR*(1 - XCR)*exp(-7.1543718172640256*XCR*(-XCR - XNB + 1) + 3.3541967644499233*XCR) - 1.8295676400933012e-26*XCR*(XCR + XNB)*exp(-8.5221193705645018*XCR*(-XCR - XNB + 1) + 4.0036674816806448*XCR - 0.81532998999390471*XNB)) - XNB*(3.5027570743586953e-26*XCR*(-XCR - XNB + 1)*exp(-7.1543718172640256*XCR*(-XCR - XNB + 1) + 3.3541967644499233*XCR) + 1.7235555733323438e-25*XNB*(-XCR - XNB + 1)*exp(-1.8707061811433989*XNB) + 1.8295676400933012e-26*(XCR + XNB)*(XCR + XNB)*exp(-8.5221193705645018*XCR*(-XCR - XNB + 1) + 4.0036674816806448*XCR - 0.81532998999390471*XNB)) + (1 - XNB)*(3.5027570743586953e-26*XCR*XNB*exp(-7.1543718172640256*XCR*(-XCR - XNB + 1) + 3.3541967644499233*XCR) - 1.7235555733323438e-25*XNB*(1 - XNB)*exp(-1.8707061811433989*XNB) - 1.8295676400933012e-26*XNB*(XCR + XNB)*exp(-8.5221193705645018*XCR*(-XCR - XNB + 1) + 4.0036674816806448*XCR - 0.81532998999390471*XNB))) - XNB*(-XNB*(1.7235555733323438e-25*XCR*XNB*exp(-1.8707061811433989*XNB) + 1.8295676400933012e-26*XCR*(-XCR - XNB + 1)*exp(-8.5221193705645018*XCR*(-XCR - XNB + 1) + 4.0036674816806448*XCR - 0.81532998999390471*XNB) + 3.5027570743586953e-26*(1 - XCR)*(1 - XCR)*exp(-7.1543718172640256*XCR*(-XCR - XNB + 1) + 3.3541967644499233*XCR)) - XNB*(1.7235555733323438e-25*XNB*(-XCR - XNB + 1)*exp(-1.8707061811433989*XNB) - 3.5027570743586953e-26*(1 - XCR)*(-XCR - XNB + 1)*exp(-7.1543718172640256*XCR*(-XCR - XNB + 1) + 3.3541967644499233*XCR) - 1.8295676400933012e-26*(XCR + XNB)*(-XCR - XNB + 1)*exp(-8.5221193705645018*XCR*(-XCR - XNB + 1) + 4.0036674816806448*XCR - 0.81532998999390471*XNB)) + (1 - XNB)*(-3.5027570743586953e-26*XNB*(1 - XCR)*exp(-7.1543718172640256*XCR*(-XCR - XNB + 1) + 3.3541967644499233*XCR) - 1.7235555733323438e-25*XNB*(1 - XNB)*exp(-1.8707061811433989*XNB) - 1.8295676400933012e-26*XNB*(XCR + XNB)*exp(-8.5221193705645018*XCR*(-XCR - XNB + 1) + 4.0036674816806448*XCR - 0.81532998999390471*XNB))) + (1 - XNB)*(-XNB*(-3.5027570743586953e-26*XCR*(1 - XCR)*exp(-7.1543718172640256*XCR*(-XCR - XNB + 1) + 3.3541967644499233*XCR) - 1.7235555733323438e-25*XCR*(1 - XNB)*exp(-1.8707061811433989*XNB) + 1.8295676400933012e-26*XCR*(-XCR - XNB + 1)*exp(-8.5221193705645018*XCR*(-XCR - XNB + 1) + 4.0036674816806448*XCR - 0.81532998999390471*XNB)) - XNB*(3.5027570743586953e-26*XCR*(-XCR - XNB + 1)*exp(-7.1543718172640256*XCR*(-XCR - XNB + 1) + 3.3541967644499233*XCR) - 1.7235555733323438e-25*(1 - XNB)*(-XCR - XNB + 1)*exp(-1.8707061811433989*XNB) - 1.8295676400933012e-26*(XCR + XNB)*(-XCR - XNB + 1)*exp(-8.5221193705645018*XCR*(-XCR - XNB + 1) + 4.0036674816806448*XCR - 0.81532998999390471*XNB)) + (1 - XNB)*(3.5027570743586953e-26*XCR*XNB*exp(-7.1543718172640256*XCR*(-XCR - XNB + 1) + 3.3541967644499233*XCR) + 1.8295676400933012e-26*XNB*(-XCR - XNB + 1)*exp(-8.5221193705645018*XCR*(-XCR - XNB + 1) + 4.0036674816806448*XCR - 0.81532998999390471*XNB) + 1.7235555733323438e-25*(1 - XNB)*(1 - XNB)*exp(-1.8707061811433989*XNB)));
