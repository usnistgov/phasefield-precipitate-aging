                       ...
                       const int bx, const int by)
{
	...
	fictitious_gam_kernel<<< num_tiles, tile_size>>>
	(dev->conc_Cr_old,
	 dev->conc_Nb_old,
	 dev->phi_del_old,
	 dev->phi_lav_old,
	...
	fictitious_del_kernel<<< num_tiles, tile_size>>>
	(dev->conc_Cr_old,
	 dev->conc_Nb_old,
	 dev->phi_del_old,
	 dev->phi_lav_old,
	...
	fictitious_lav_kernel<<< num_tiles, tile_size>>>
	(dev->conc_Cr_old,
	 dev->conc_Nb_old,
	 dev->phi_del_old,
	 dev->phi_lav_old,
                       ...
                       const int bx, const int by)
{
	...
	mobility_gam_kernel<<< num_tiles, tile_size>>>
	(dev->conc_Cr_old,
	 dev->conc_Nb_old,
	 dev->phi_del_old,
	 dev->phi_lav_old,
	...
	mobility_del_kernel<<< num_tiles, tile_size>>>
	(dev->conc_Cr_old,
	 dev->conc_Nb_old,
	 dev->phi_del_old,
	 dev->mob_del_CrCr,
	...
	mobility_lav_kernel<<< num_tiles, tile_size>>>
	(dev->conc_Cr_old,
	 dev->conc_Nb_old,
	 dev->phi_lav_old,
	 dev->mob_lav_CrCr,
