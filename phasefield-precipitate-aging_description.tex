...
\begin{document}
	...
	\section{Thermodynamic Model}
		...
		by second-order Taylor series expansion about control compositions $\mathbf{a}=(a_{\ce{Cr}}, a_{\ce{Nb}}, a_{\ce{Ni}})$ chosen empirically such that the phase diagram is qualitatively correct (Fig.~\ref{fig:taylor}).
