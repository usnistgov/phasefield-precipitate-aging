...
__device__ double d_fict_gam_Cr(double XCR, double XNB, double f_del, double f_gam, double f_lav);
__device__ double d_fict_gam_Nb(double XCR, double XNB, double f_del, double f_gam, double f_lav);
__device__ double d_fict_del_Cr(double XCR, double XNB, double f_del, double f_gam, double f_lav);
__device__ double d_fict_del_Nb(double XCR, double XNB, double f_del, double f_gam, double f_lav);
__device__ double d_fict_lav_Cr(double XCR, double XNB, double f_del, double f_gam, double f_lav);
__device__ double d_fict_lav_Nb(double XCR, double XNB, double f_del, double f_gam, double f_lav);
