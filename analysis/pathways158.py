...
for datdir in glob.glob(
    "/data/tnk10/phase-field/alloy625/TKR4p158/run*"
    ...
    if path.isdir(datdir) and len(glob.glob("{0}/*.xy".format(datdir))) > 0:
        ...
        try:
            dgcr, dgnb, dcr, dnb, lgcr, lgnb, lcr, lnb = np.loadtxt(
                "{0}/diffusion_{1}.xc".format(datdir, base),
                delimiter=",",
                skiprows=1,
                usecols=(3, 4, 5, 6, 10, 11, 12, 13),
                unpack=True,
            )
            plt.plot(
        ...
        plt.legend(loc="best")
        plt.savefig(
            "diagrams/TKR4p158/pathways/pathways_{0}.png".format(base),
            dpi=400,
            bbox_inches="tight",
        )
        ...
        plt.savefig(
            "diagrams/TKR4p158/pathways/pathways_zm_gam_{0}.png".format(base),
            dpi=400,
            bbox_inches="tight",
        )
        ...
        plt.savefig(
            "diagrams/TKR4p158/pathways/pathways_zm_del_{0}.png".format(base),
            dpi=400,
            bbox_inches="tight",
        )
        ...
        plt.savefig(
            "diagrams/TKR4p158/pathways/pathways_zm_lav_{0}.png".format(base),
            dpi=400,
            bbox_inches="tight",
        )
        ...
        plt.ylim([0, rt3by2 * 0.6])
        plt.savefig(
            "diagrams/TKR4p158/triangles/composition_{0}.png".format(base),
            dpi=300,
            bbox_inches="tight",
        )
        plt.close()
