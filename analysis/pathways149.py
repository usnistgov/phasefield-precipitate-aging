...
for datdir in glob.glob("data/alloy625/TKR4p149/run*/"):
    if path.isdir(datdir) and len(glob.glob("{0}/*.xy".format(datdir))) > 0:
        ...
        plt.legend(loc="best")
        plt.savefig(
            "diagrams/TKR4p149/pathways/pathways_{0}.png".format(base),
            dpi=400,
            bbox_inches="tight",
        )
        ...
        plt.savefig(
            "diagrams/TKR4p149/pathways/pathways_zm_gam_{0}.png".format(base),
            dpi=400,
            bbox_inches="tight",
        )
        ...
        plt.ylim([0, rt3by2 * 0.6])
        plt.savefig(
            "diagrams/TKR4p149/triangles/composition_{0}.png".format(base),
            dpi=300,
            bbox_inches="tight",
        )
        plt.close()
