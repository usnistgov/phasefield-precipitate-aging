...
double M_CrCr(double XCR, double XNB)
{
	...
	M_CrCr_result = 1.8295676400933012e-21*pow(XCR, 2)*exp(-8.5221193705645018*XCR*(-XCR - XNB + 1) + 4.0036674816806448*XCR - 0.81532998999390471*XNB) + 1.7235555733323437e-20*pow(XCR, 2)*exp(-1.8707061811433989*XNB) + 3.5027570743586952e-21*pow(1 - XCR, 2)*exp(-7.1543718172640256*XCR*(-XCR - XNB + 1) + 3.3541967644499233*XCR);
...
double M_CrNb(double XCR, double XNB)
{
	...
	M_CrNb_result = 1.8295676400933012e-21*XCR*XNB*exp(-8.5221193705645018*XCR*(-XCR - XNB + 1) + 4.0036674816806448*XCR - 0.81532998999390471*XNB) - 1.7235555733323437e-20*XCR*(1 - XNB)*exp(-1.8707061811433989*XNB) - 3.5027570743586952e-21*XNB*(1 - XCR)*exp(-7.1543718172640256*XCR*(-XCR - XNB + 1) + 3.3541967644499233*XCR);
...
double M_NbCr(double XCR, double XNB)
{
	...
	M_NbCr_result = 1.8295676400933012e-21*XCR*XNB*exp(-8.5221193705645018*XCR*(-XCR - XNB + 1) + 4.0036674816806448*XCR - 0.81532998999390471*XNB) - 1.7235555733323437e-20*XCR*(1 - XNB)*exp(-1.8707061811433989*XNB) - 3.5027570743586952e-21*XNB*(1 - XCR)*exp(-7.1543718172640256*XCR*(-XCR - XNB + 1) + 3.3541967644499233*XCR);
...
double M_NbNb(double XCR, double XNB)
{
	...
	M_NbNb_result = 3.5027570743586952e-21*pow(XNB, 2)*exp(-7.1543718172640256*XCR*(-XCR - XNB + 1) + 3.3541967644499233*XCR) + 1.8295676400933012e-21*pow(XNB, 2)*exp(-8.5221193705645018*XCR*(-XCR - XNB + 1) + 4.0036674816806448*XCR - 0.81532998999390471*XNB) + 1.7235555733323437e-20*pow(1 - XNB, 2)*exp(-1.8707061811433989*XNB);
