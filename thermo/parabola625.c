...
double mu_Cr(double XCR, double XNB)
{
	...
	double mu_Cr_result;
	mu_Cr_result = -2111099999.9999998*pow(XCR, 2)*XNB*(-XCR - XNB + 1) - 2111099999.9999998*XCR*pow(XNB, 2)*(-XCR - XNB + 1) - 2111099999.9999998*XCR*XNB*pow(-XCR - XNB + 1, 2) + 1474821796.9999993*XCR*(-XCR - XNB + 1)*(2*XCR + XNB - 1) - 669388631.5*XCR*(-XCR - XNB + 1) + 1707300680.1792684*XCR + 6973684804.4499979*XNB*(-XCR - XNB + 1)*(XCR + 2*XNB - 1) - 7846288044.7499981*XNB*(-XCR - XNB + 1) - 99999.999999999985*XNB*(21111.0*pow(XCR, 2)*XNB - 21111.0*pow(XCR, 2)*(-XCR - XNB + 1) + 21111.0*XCR*pow(XNB, 2) - 42222.0*XCR*XNB*(-XCR - XNB + 1) - 21111.0*XCR*XNB*(2*XCR + 2*XNB - 2) - 21111.0*XCR*pow(-XCR - XNB + 1, 2) + 14748.217969999996*XCR*(-XCR - XNB + 1) - 14748.217969999996*XCR*(2*XCR + XNB - 1) + 85156.766762499989*XCR + 139473.69608899998*XNB*(-XCR - XNB + 1) - 69736.848044499988*XNB*(XCR + 2*XNB - 1) + 156925.76089499998*XNB + 9504.7206750000023*(1.9099999999999999*XCR - 0.52000000000000002)*((1.9099999999999999*XCR*(-XCR - XNB + 1) + 2.98*XCR + 0.52000000000000002*XNB - 0.52000000000000002 >= 0) ? (
	                   -0.33333333333333298
	               )
	               : (
	                   1.0
...
double mu_Nb(double XCR, double XNB)
{
	...
	double mu_Nb_result;
	mu_Nb_result = -2111099999.9999998*pow(XCR, 2)*XNB*(-XCR - XNB + 1) - 2111099999.9999998*XCR*pow(XNB, 2)*(-XCR - XNB + 1) - 2111099999.9999998*XCR*XNB*pow(-XCR - XNB + 1, 2) + 1474821796.9999993*XCR*(-XCR - XNB + 1)*(2*XCR + XNB - 1) - 669388631.5*XCR*(-XCR - XNB + 1) - 99999.999999999985*XCR*(21111.0*pow(XCR, 2)*XNB + 21111.0*XCR*pow(XNB, 2) - 42222.0*XCR*XNB*(-XCR - XNB + 1) - 21111.0*XCR*XNB*(2*XCR + 2*XNB - 2) + 29496.435939999992*XCR*(-XCR - XNB + 1) - 14748.217969999996*XCR*(2*XCR + XNB - 1) + 13387.772630000001*XCR - 21111.0*pow(XNB, 2)*(-XCR - XNB + 1) - 21111.0*XNB*pow(-XCR - XNB + 1, 2) + 69736.848044499988*XNB*(-XCR - XNB + 1) - 69736.848044499988*XNB*(XCR + 2*XNB - 1) + 85156.766762499989*XNB + (-14748.217969999996*XCR - 14748.217969999996*XNB + 14748.217969999996)*(2*XCR + XNB - 1) + 9504.7206750000023*((XCR > 9.9999999999999998e-17) ? (
	                   log(XCR) + 1
	               )
	               : (
	                   0
...
double mu_Ni(double XCR, double XNB)
{
	...
	double mu_Ni_result;
	mu_Ni_result = -2111099999.9999998*pow(XCR, 2)*XNB*(-XCR - XNB + 1) - 2111099999.9999998*XCR*pow(XNB, 2)*(-XCR - XNB + 1) - 2111099999.9999998*XCR*XNB*pow(-XCR - XNB + 1, 2) + 1474821796.9999993*XCR*(-XCR - XNB + 1)*(2*XCR + XNB - 1) - 669388631.5*XCR*(-XCR - XNB + 1) - 99999.999999999985*XCR*(21111.0*pow(XCR, 2)*XNB + 21111.0*XCR*pow(XNB, 2) - 42222.0*XCR*XNB*(-XCR - XNB + 1) - 21111.0*XCR*XNB*(2*XCR + 2*XNB - 2) + 29496.435939999992*XCR*(-XCR - XNB + 1) - 14748.217969999996*XCR*(2*XCR + XNB - 1) + 13387.772630000001*XCR - 21111.0*pow(XNB, 2)*(-XCR - XNB + 1) - 21111.0*XNB*pow(-XCR - XNB + 1, 2) + 69736.848044499988*XNB*(-XCR - XNB + 1) - 69736.848044499988*XNB*(XCR + 2*XNB - 1) + 85156.766762499989*XNB + (-14748.217969999996*XCR - 14748.217969999996*XNB + 14748.217969999996)*(2*XCR + XNB - 1) + 9504.7206750000023*((XCR > 9.9999999999999998e-17) ? (
	                   log(XCR) + 1
	               )
	               : (
	                   0
...
double D_CrCr(double XCR, double XNB)
{
	...
	D_CrCr_result = -1.4170990277916467e-15*XCR*XNB*(-45342.644255240499*XCR - 150954.82346486227*XNB + 150954.82346486227)*exp(-34.982563536715503*XNB*(-XCR - XNB + 1) + 14.437947842988088*XNB) + 3.5027570743586948e-16*XCR*(1 - XCR)*(-45342.644255240499*XCR - 150954.82346486227*XNB + 45342.644255240499)*exp(-7.1543718172640256*XCR*(-XCR - XNB + 1) + 3.3541967644499233*XCR) - 1.8295676400933009e-16*XCR*(-45342.644255240499*XCR - 150954.82346486227*XNB)*(-XCR - XNB + 1)*exp(-8.5221193705645018*XCR*(-XCR - XNB + 1) + 4.0036674816806448*XCR - 442.62877981749585*XNB*(-XCR - XNB + 1) - 0.82164267100913768*XNB);
...
double D_CrNb(double XCR, double XNB)
{
	...
	D_CrNb_result = -1.4170990277916467e-15*XCR*XNB*(-150954.82346486227*XCR - 1103861.6648137188*XNB + 1103861.664813719)*exp(-34.982563536715503*XNB*(-XCR - XNB + 1) + 14.437947842988088*XNB) + 3.5027570743586948e-16*XCR*(1 - XCR)*(-150954.82346486227*XCR - 1103861.6648137188*XNB + 150954.82346486225)*exp(-7.1543718172640256*XCR*(-XCR - XNB + 1) + 3.3541967644499233*XCR) - 1.8295676400933009e-16*XCR*(-150954.82346486227*XCR - 1103861.6648137188*XNB)*(-XCR - XNB + 1)*exp(-8.5221193705645018*XCR*(-XCR - XNB + 1) + 4.0036674816806448*XCR - 442.62877981749585*XNB*(-XCR - XNB + 1) - 0.82164267100913768*XNB);
...
double D_NbCr(double XCR, double XNB)
{
	...
	D_NbCr_result = -3.5027570743586948e-16*XCR*XNB*(-45342.644255240499*XCR - 150954.82346486227*XNB + 45342.644255240499)*exp(-7.1543718172640256*XCR*(-XCR - XNB + 1) + 3.3541967644499233*XCR) + 1.4170990277916467e-15*XNB*(1 - XNB)*(-45342.644255240499*XCR - 150954.82346486227*XNB + 150954.82346486227)*exp(-34.982563536715503*XNB*(-XCR - XNB + 1) + 14.437947842988088*XNB) - 1.8295676400933009e-16*XNB*(-45342.644255240499*XCR - 150954.82346486227*XNB)*(-XCR - XNB + 1)*exp(-8.5221193705645018*XCR*(-XCR - XNB + 1) + 4.0036674816806448*XCR - 442.62877981749585*XNB*(-XCR - XNB + 1) - 0.82164267100913768*XNB);
...
double D_NbNb(double XCR, double XNB)
{
	...
	D_NbNb_result = -3.5027570743586948e-16*XCR*XNB*(-150954.82346486227*XCR - 1103861.6648137188*XNB + 150954.82346486225)*exp(-7.1543718172640256*XCR*(-XCR - XNB + 1) + 3.3541967644499233*XCR) + 1.4170990277916467e-15*XNB*(1 - XNB)*(-150954.82346486227*XCR - 1103861.6648137188*XNB + 1103861.664813719)*exp(-34.982563536715503*XNB*(-XCR - XNB + 1) + 14.437947842988088*XNB) - 1.8295676400933009e-16*XNB*(-150954.82346486227*XCR - 1103861.6648137188*XNB)*(-XCR - XNB + 1)*exp(-8.5221193705645018*XCR*(-XCR - XNB + 1) + 4.0036674816806448*XCR - 442.62877981749585*XNB*(-XCR - XNB + 1) - 0.82164267100913768*XNB);
