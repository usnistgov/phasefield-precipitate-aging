...
double we_gam_Cr() {
   ...
   double we_gam_Cr_result;
   we_gam_Cr_result = 0.52500000000000002;
   return we_gam_Cr_result;

}

double we_gam_Nb() {

   double we_gam_Nb_result;
   we_gam_Nb_result = 0.017999999999999999;
   return we_gam_Nb_result;

}

double we_del_Cr() {

   double we_del_Cr_result;
   we_del_Cr_result = 0.0258;
   return we_del_Cr_result;

}

double we_del_Nb() {

   double we_del_Nb_result;
   we_del_Nb_result = 0.24399999999999999;
   return we_del_Nb_result;

}

double we_lav_Cr() {

   double we_lav_Cr_result;
   we_lav_Cr_result = 0.375;
   return we_lav_Cr_result;

}

double we_lav_Nb() {

   double we_lav_Nb_result;
   we_lav_Nb_result = 0.25900000000000001;
   return we_lav_Nb_result;
